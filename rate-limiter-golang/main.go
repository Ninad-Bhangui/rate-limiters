...
func createTokenBucket(bucketSize int, refillRate int, internalFunc func()) *TokenBucket {
...
func main() {
	limiter := createTokenBucket(3, 1, func() { fmt.Println("internal function invoked") })
